...
class _$DataImpl implements _Data {
  const _$DataImpl(final List<Patient> patients) : _patients = patients;
  ...
  @override
  String toString() {
    return 'PatientState.data(patients: $patients)';
  }
...
abstract class _Data implements PatientState {
  const factory _Data(final List<Patient> patients) = _$DataImpl;
